...
export const ProjectItem: SLIDE_ITEM[] = [
  ...
  { name: "catNeighbor", src: catNeighbor },
  { name: "jaeumi", src: jaeumi },
  { name: "kuMap", src: kuMap },
  { name: "naviya", src: naviya },
  { name: "nowWhat", src: nowWhat },
  { name: "sent", src: sent },
  { name: "solitaryDiningRoom", src: solitaryDiningRoom },
  { name: "spaceDaily", src: spaceDaily },
  { name: "tabam", src: tabam },
  { name: "timeBank", src: timeBank },
  { name: "toTomorrow", src: toTomorrow },
];
