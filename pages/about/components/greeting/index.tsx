      ...
      <S.TextWrapper isMobile={isMobile}>
        <S.TextElementWrapper data-aos="fade">
          <div>
            ...
            <p>
              코딩. 따분한 강의와 두꺼운 교재에 결국 흐지부지 끝나버리지는
              않으셨나요?
            </p>
            <p>
              창업. 아이디어는 떠오르지만 현실로 만들 방법을 몰라, 함께할 사람이
              없어 묻어두지는 않으셨나요?
            </p>
            <p>
              앞으로 1년 동안 운영진들이 자체적으로 구축한 커리큘럼과 세션을
              통해 개발을 학습하며 소프트웨어 역량을 기르게 됩니다.
            </p>
            <p>
              또한, NEXT의 파트너 eo PLANET의 창업 교육 과정을 통해 기업가적
              마인드셋을 갖추게 됩니다.
            </p>
            <p>
              시장에서 문제를 찾고 프로덕트를 개발하는 두 학습을 실전 프로젝트를
              통해 병행하며, 문제 해결 능력을 갖춘 스타트업 인재로 성장합니다.
            </p>
            <p>
              공동의 목표를 가진 동료들, 여러 서비스를 직접 만들고 시장에서
              테스트하며 축적한 실전 역량, 다양한 분야의 사람들과 네트워킹할 수
              있는 기회까지.
            </p>
            <p>
              우리는 더 넓은 세상을 마주하게 될 것이고, 그 과정에서 동료들과
              열정을 공유하며 내가 그리는 비전에 가까워질 것입니다.{" "}
            </p>
            <p>지금껏 경험해본적 없는 폭발적인 성장을 기대하며, </p>
            <p>NEXT라는 로켓에 올라타세요.</p>
            <p>
              <b>ACCELERATE YOUR POTENTIAL.</b>
            </p>
          </div>
          <p>
            <b
            ...
            >
              대표
              <b
                style={{ color: "#000", fontWeight: "500", paddingLeft: "3px" }}
              >
                김하경
              </b>
              | 부대표
